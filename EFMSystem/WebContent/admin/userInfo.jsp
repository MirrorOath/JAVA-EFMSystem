...
<script type="text/javascript">
                $(function () {
                    $('#dg').edatagrid({
                        url: '../easyUI/easyUIGetUsers.action',
                        saveUrl: '../easyUI/easyUISaveUser.action',
                        updateUrl: '../easyUI/easyUIUpdateUser.action',
                        destroyUrl: '../easyUI/easyUIDelUser.action'
                    });
                });
            </script>
<title>管理用户</title>
...
<body>
	...
	<div>
		...
		<table id="dg" title="用户信息" style="width: 1000px; height: 700px"
				...
				<tr>
                    ...
                    <th field="tell" width="50"
                     ...
                     <th field="role" width="50"
                        editor="{type:'validatebox',options:{required:true}}">用户类型</th>
                     <th field="roleStr" width="50"
                        editor="{type:'validatebox',options:{readonly:true}}">用户类型名称</th>
