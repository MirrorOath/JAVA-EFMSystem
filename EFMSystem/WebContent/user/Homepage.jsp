                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="panel-836193">
                            <div>
                                ...
                                <p>
                                <h3>
                                    每月一号抄上月电表<br /> 谷峰计费: 22:00--6:00
                                    1元/度电 6:00--22:00 2元/度电 </br> 普通计费:
                                    全天2元/度电
                                </h3>
                                </p>
                                <table class="table">
                        ...
                        <div class="tab-pane" id="panel-312882">
                            <div>
                                ...
                                <form class="form-horizontal"
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3"
                                            class="col-sm-3 control-label">地址</label>
                                        <div class="col-sm-9">
                                            <input name="address"
                                                class="form-control"
                                                type="text"
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3"
                                            class="col-sm-3 control-label">用户类型</label>
                                        <div class="col-sm-9">
                                            <input name="money"
                                                class="form-control"
                                                type="text"
                                                disabled="true"
                                                id="lastMoney"
                                                value="${(userInfo.role == 1) ? '商家用户' : '居民用户'}" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail3"
                                            class="col-sm-3 control-label">计费方式</label>
                                        <div class="col-sm-9">
                                            <input name="tactics"
                                                class="form-control"
                                                type="text"
                                                required="true"
                                                value="${userInfo.tactics }" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div
                                            ...
                                            <button type="submit"
                                                class="btn btn-default">提交修改</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
